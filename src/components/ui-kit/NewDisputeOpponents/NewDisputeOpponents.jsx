...
export const NewDisputeOpponents = ({
  ...
  return (
    <div className={`new-dipute-opponents__choice ${chooseOpponentModal && 'new-dipute-opponents__choice_opened'}`}>
      {/* Выбранные опоненты */}
      ...
      <div className="new-dispute-opponents__input-frame">
        ...
        <button
          className={`new-dispute-opponents__button ${chooseOpponentModal && 'new-dispute-opponents__button_rotate'}`}
          type="button"
